...
plt.figure()
plt.scatter(C1_test_500[:, 0], C1_test_500[:, 1], color='red', label='Classe C1 (500 eventos)')
plt.scatter(C2_test_500[:, 0], C2_test_500[:, 1], color='blue', label='Classe C2 (500 eventos)')
plt.plot(x_values, y_values_mse_500, color='green', label='Classificador MSE  (500 eventos)')
plt.plot(x_values, y_values_bayes, '--', color='purple', label='Classificador de Bayes')
plt.xlabel('Feature 1')
plt.ylabel('Feature 2')
plt.title('7) Classificadores MSE e Bayes com 500 eventos de treinamento')
plt.legend()
plt.grid(True)
plt.savefig(os.path.join(save_directory, '7-MSE_Bayes_500_Events.png'), dpi=300)

# Plot para análise com 50 eventos
plt.figure()
plt.scatter(C1_test_50[:, 0], C1_test_50[:, 1], color='red', label='Classe C1 (50 eventos)')
plt.scatter(C2_test_50[:, 0], C2_test_50[:, 1], color='blue', label='Classe C2 (50 eventos)')
plt.plot(x_values, y_values_mse_50, color='green', label='Classificador MSE (50 eventos)')
plt.plot(x_values, y_values_bayes, '--', color='purple', label='Classificador de Bayes')
plt.xlabel('Feature 1')
plt.ylabel('Feature 2')
plt.title('8) Classificadores MSE e de Bayes com 50 eventos' )
plt.legend()
plt.grid(True)
plt.savefig(os.path.join(save_directory, '8-MSE_Bayes_50_Events.png'), dpi=300)
...
plt.scatter(C1_test_50[:, 0], C1_test_50[:, 1], color='red', label='Classe C1 (50 eventos)')
plt.scatter(C2_test_50[:, 0], C2_test_50[:, 1], color='blue', label='Classe C2 (50 eventos)')
plt.plot(x_values, y_values_mse_new_50, color='green', label='Classificador MSE com 50 novos eventos')
plt.plot(x_values, y_values_bayes, '--', color='purple', label='Classificador de Bayes')
plt.xlabel('Feature 1')
plt.ylabel('Feature 2')
plt.title('9) Classificadores MSE e de Bayes com 50 novos eventos')
plt.legend()
plt.grid(True)
plt.savefig(os.path.join(save_directory, '9-MSE_Bayes_50_new_Events.png'), dpi=300)
...
plt.figure()
plt.scatter(C1_test_500[:, 0], C1_test_500[:, 1], color='red', label='Classe C1')
plt.scatter(C2_test_500[:, 0], C2_test_500[:, 1], color='blue', label='Classe C2')
plt.plot(x_values, y_values_svm, color='green', label='Classificador SVM linear - suave')
plt.plot(x_values, y_values_bayes, '--', color='purple', label='Classificador de Bayes')
plt.xlabel('Feature 1')
plt.ylabel('Feature 2')
plt.title('10) Classificadores SVM e de Bayes ')
plt.legend()
plt.grid(True)
plt.savefig(os.path.join(save_directory, '10-SVM_Bayes_500_Events.png'), dpi=300)
...
plt.figure()
plt.scatter(C1_test_50[:, 0], C1_test_50[:, 1], color='red', label='Classe C1')
plt.scatter(C2_test_50[:, 0], C2_test_50[:, 1], color='blue', label='Classe C2')
plt.plot(x_values, y_values_svm_new, color='green', label='Classificador SVM linear - suave 50 novos eventos')
plt.plot(x_values, y_values_bayes, '--', color='purple', label='Classificador de Bayes')
plt.xlabel('Feature 1')
plt.ylabel('Feature 2')
plt.title('11) Classificadores SVM e Bayes com 50 novos eventos')
plt.legend()
plt.grid(True)
plt.savefig(os.path.join(save_directory, '11-SVM_Bayes_50_new_Events.png'), dpi=300)
